...
from customer.views import Index, About, Order, OrderConfirmations, OrderPayConfirmation, Menu, MenuSearch
...
urlpatterns = [
    ...
    path('menu/serch/', MenuSearch.as_view(), name='menu-search'),
